; Bitmap glyphs are the standard IBM PC CGA/VGA 8x8 ROM font
; (Code Page 437, public domain).
...
font_data:
    ...
    ; 0x32: 2
    db 0x3C, 0x66, 0x06, 0x1C, 0x38, 0x60, 0x7E, 0x00
...
; 0x56: V
db 0x66, 0x66, 0x66, 0x66, 0x3C, 0x3C, 0x18, 0x00

; 0x57: W
db 0x63, 0x63, 0x6B, 0x6B, 0x7F, 0x77, 0x63, 0x00
...
db 0x66, 0x66, 0x3C, 0x18, 0x3C, 0x66, 0x66, 0x00
    ...
    ; 0x5C: \
    ; legit not joking, adding this line fixed it
    ; i recommend doing incbin instead of a 291 line .asm file
    ...
    ; 0x66: f
    db 0x1C, 0x30, 0x7C, 0x30, 0x30, 0x30, 0x30, 0x00
    ...
    ; 0x6A: j
    db 0x06, 0x00, 0x06, 0x06, 0x06, 0x06, 0x66, 0x3C
    ...
    ; 0x6D: m
    db 0x00, 0x00, 0x66, 0x7F, 0x6B, 0x6B, 0x63, 0x00
    ...
    ; 0x73: s
    db 0x00, 0x00, 0x3C, 0x60, 0x3C, 0x06, 0x7C, 0x00
...
; 0x77: w
db 0x00, 0x00, 0x63, 0x6B, 0x6B, 0x7F, 0x36, 0x00
...
db 0x00, 0x00, 0x66, 0x3C, 0x18, 0x3C, 0x66, 0x00
    ...
    ; 0x7E: ~
    db 0x00, 0x00, 0x73, 0xDE, 0x00, 0x00, 0x00, 0x00
